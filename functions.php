		...
		<article id="comment-<?php comment_ID(); ?>" >
			<div class="comment-author vcard clearfix">
                ...
                <?php if ($comment->comment_approved == '0') : ?>
                    ...
                    <time datetime="<?php echo comment_time('Y-m-j'); ?>"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php comment_time('F jS, Y'); ?> </a>
                    </time>

                    <?php edit_comment_link(__('修改','wpbootstrap'),'<span class="btn btn-info"><i class="glyphicon-white glyphicon-pencil"></i>','</span>') ?>
                    <span class="btn btn-primary"><?php comment_reply_link(array_merge( $args, array('depth' => $depth, 'max_depth' => $args['max_depth']))) ?></span>
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'wpbs', get_template_directory_uri() . '/library/dist/css/bootstrap.css', array(), '1.0', 'all' );
        wp_register_style( 'wpbs2', get_template_directory_uri() . '/library/dist/css/bootstrap-theme.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'wpbs' );
        wp_enqueue_style( 'wpbs2' );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'modernizr', 
      ...
      array('jquery'), 
      '1.2',true );
	wp_register_script( 'javasparrow',get_template_directory_uri() . '/library/dist/js/javasparrow.js',array('bootstrap'), '',true );
	wp_register_script( 'ajaxloader',get_template_directory_uri() . '/library/dist/js/ajaxloader.js',array('bootstrap'), '',true );  
	  
  
    wp_enqueue_script( 'bootstrap' );
    wp_enqueue_script( 'wpbs-js' );
    wp_enqueue_script( 'modernizr' );
    wp_enqueue_script( 'javasparrow' );
...
function replace_jquery() {
	...
	wp_register_script('jquery', 'https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js', false, '3.2.1');
